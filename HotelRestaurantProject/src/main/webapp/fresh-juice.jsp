...
String pageTitle = "Fresh Juice";
String categoryName = "Fresh Juice";
String qtyPrefix = "juice_q";
%>
...
<section class="page-banner">
    <h1><%= pageTitle %></h1>
    <p>Healthy and natural fruit juices.</p>
</section>
...
%>
 <div class="food-card food-scroll-item">
        ...
        <a href="food-details.jsp?id=<%= rs.getInt("id") %>">
            <img src="<%= rs.getString("image") %>" alt="<%= foodName %>">
        </a>
...
%>
    ...
    <h2 style="text-align:center; color:#5a2d0c;">No foods available</h2>
...
%>
    <h2 style="text-align:center; color:red;">Error loading foods: <%= e.getMessage() %></h2>
<%
}
%>
