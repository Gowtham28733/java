...
Integer managerBranchId = (Integer) session.getAttribute("branchId");

if (manager == null || managerBranchId == null) {
...
try {
    ...
    while (rs.next()) {
        ...
        String statusClass =
            "Active".equalsIgnoreCase(status) ? "active" : "inactive";
...
<tr>
    <td colspan="17">No staff found for this branch</td>
</tr>
